...
The German language file (`de.json`) is the **original source language**. It is recommended to start translations from German or English. (English serves as the fallback language and will be used whenever a language or translation entry is missing.)
