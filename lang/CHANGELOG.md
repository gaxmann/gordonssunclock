...
- Structure: variables for certain list/dict entries added, e.g. {solcal_lph|2} or whole list {solcal_lph|**}

## [1.5] - 2025-11
- Added: _meta (version, updated), ordinalsh (new key rules with gender distinction)
- Changed: xxdays (new keys for plural rules)
- Structure: variables for quoted labels added, e.g. {txgpsauto} or without quotes {txgpsauto-}; also {auto} 
