...
- _**Android 5+:** From May 2026 onwards, the Play Store version requires Android 7+. A legacy **`a5`** build for older or lower-spec devices remains available via GitHub releases (Android 5–14)_
