...
I was dissatisfied with standard time, the recurring time changes and the fact that 12 o'clock is usually not noon. My solution: an organic dial that shows the sun's ☀️ actual position and path, shows when it's at its highest point, and when the sun disappears below the horizon – all calculated for your individual location. Standard clocks tell you the time. Sun Clock tells you where you are in the day.
...
- _**Android 5–6:** From May 2026, the Play Store version requires Android 7+. A legacy build for Android 5–6 remains available on GitHub releases._
