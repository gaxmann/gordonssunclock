...
- **[Web version](https://astronomicalclock.eu/)** (for all devices)
  ...
  - The web version is also available as a separate **[Android app](https://github.com/gaxmann/astronomicalclock)**, currently in closed Google Play testing.
...
- **Multi-language**: Deutsch, English, Español, Français, Русский, 中文, Português, Italiano plus some autotranslated languages
