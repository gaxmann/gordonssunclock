...
- _**Android 5+:** From May 2026 onwards, the Play Store version requires Android 7+. A legacy **`a5`** build for older (Android 5–14) or lower-spec devices remains available via GitHub releases._
