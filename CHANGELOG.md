...
### Changed
- Display of patchnr on About page, compare logic changed to 3+1 parts (therefore new 2.71 version, also last time this is necessary to trigger update for wall clocks)
