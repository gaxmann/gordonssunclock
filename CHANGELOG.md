...
### Added
- [Experimental] If the system language is not among the supported languages, an auto-translation download will be attempted from my website. If successful, a popup appears and the auto-translated language can be selected via the language selector (marked with "(α)")
