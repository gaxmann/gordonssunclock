...
## [3.3.4] - 2026-07-xx (7 day weather preview) 
...
- Now 22 stars (the 21 brightest plus Polaris) instead of 10, but only the stars that are at all visible will be shown
...
- Button were very smal on devices with low dpi
...
- Weather is current mark now on temp instead of sun hours
...
- Texts updated for night/darkness alarms
...
**New main line release with 16 kB page support, api24/Android 7+, arm64-v8a only**
...
- layout updates only after 2 min of no usage plus 3s delayed on_resume
