...
### Added
- Experimental: If the system language is not among the supported languages, an auto-translation will be tried to download from my website. If successfull a popup will appear and the auto-translated language can be selected via the language selector (marked with "(α)")
