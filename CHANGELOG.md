...
### Added
- [Experimental] The app now ships with additional auto-translated languages: Português, Türkçe, Italiano. These languages are marked with "α". - As this feature is experimental and dependent on other servies, the set of available auto-translated languages may change (or be removed) at any time
