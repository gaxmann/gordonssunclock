...
- From now on, the preview line (Android 7+) is the new **`main`** line. The previous main line becomes the legacy line and uses the **`a5`** suffix, which hereby receives its final app store release. A separate GitHub repository has been created for the distribution of the **`a5`** apk
