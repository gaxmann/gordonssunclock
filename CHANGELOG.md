...
### Fixed
- Dial rendering on startup is fast again: the quick draft-pass dial now reliably displays instead of not appearing, which previously caused an unnecessary wait for the hires rerun
