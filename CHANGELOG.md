...
## [2.67.3] - 2026-01-31 (Weather Overview)
...
- Lang V1.7: New variable logic for the lang file ({solcal_lph|0-}). Updated website code to correctly process and display the new language files.
