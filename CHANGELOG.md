...
### Added
- Gordian Light Calendar added that shows the 4 light seasons (centered around the middle of the 4 astronomical fix points, [more info](https://github.com/gaxmann/gordonssunclock/wiki/Light-Calendar))
