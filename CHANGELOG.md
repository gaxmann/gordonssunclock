...
*Note to self: **Added** introduces new logic or data and carries the highest risk, **Changed** usually stabilises existing behaviour, and **Fixed** corrects known errors and improves stability. - When language keys are added, removed, or changed, the **minor version of the language files must be incremented manually**.*

You'll find a [short summary](./WHATSNEW.md) of the latest changes here. Below you'll find [preview versions](#dev) of the app (supporting 16 kB and Android 15+ transparent bars). - _Regular feature updates are released every 1–2 weeks; critical fixes may appear sooner._
