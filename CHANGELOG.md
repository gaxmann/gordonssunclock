...
### Changed
**Toolchain update to meet new Android platform requirements** resulting in:
...
**Final app stores release for Android 5–6** (old toolchain) due to Play Store requirements
### Added
